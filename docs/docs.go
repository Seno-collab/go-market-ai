        ...
        "/api/menus": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Comma-separated topic names, e.g. \\",
                        "name": "topics",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/menuapp.ListMenusResponse"
                        }
                    },
                    "default": {
                        "description": "Errors",
    ...
    "definitions": {
        ...
        "menuapp.ListMenusResponse": {
            ...
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/menuapp.MenuResponse"
                    }
                },
                "nextCursor": {
                    "type": "integer"
        ...
        "menuapp.MenuResponse": {
            ...
            "properties": {
                ...
                "type": {
                    "$ref": "#/definitions/domain.MenuType"
                }
            }
        },
